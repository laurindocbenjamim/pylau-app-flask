...
dataForm = [("099288", "Rice", 12.5, 19.55, 0, 25.75)]

@pytest.mark.parametrize("product_barcode, product_description, sale_price_01, sale_price_02, sale_price_03, pos_sale_price", dataForm)
# Test post method to save data to the database
def test_post(client, product_barcode, product_description, sale_price_01, sale_price_02, sale_price_03, pos_sale_price):
    """
