...
CORS(bp_projects)
bp_projects.add_url_rule('/emotion-detector', view_func=EmotionDetectorView.as_view('emotion_detector', UserToken, Users, EmotionDetector, 'package_data_science/emotion_detector.html'))
