...
class StockGetProductsView(View):
    """
    ...
    def dispatch_request(self, id = None):
        ...
        def get_all_products()->any:
            if not id or id is None:                
                ...
                if status:                    
                    products = self.model.serialize_objects(obj)   
        ...
        def get_product_by_id(id)->any:
            if isinstance(id, int):                
                ...
                if status:
                    return jsonify({"status":status, "object": obj.stock_id }, 200) 
        ...
        def get_product_by_barcode(barcode)->any:
            ...
            return jsonify({"category": obj, }, 400)
