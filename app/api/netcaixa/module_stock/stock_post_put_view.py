        ...
        if request.method =='POST':
            ...
            if code == 200:   
                ...
                if 'False' or 'false' or 0 or '0' in request.form.get('status', True):
                    prod_status = False
                data = {
                    "product_barcode": request.formget('product_barcode', None),
                    ...
                    "product_sale_price": request.form.get("product_sale_price",None),
                    ...
                    "stock_date_updated": request.form.get("stock_date_updated",None)
                }
